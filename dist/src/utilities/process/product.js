...
var Product = /** @class */ (function () {
    ...
    Product.prototype.createNewProduct = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var res, _a, product_name, product_price, product_quantity, query, conn, error_1;
    ...
    Product.prototype.edit = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var res, _a, product_id, product_name, product_price, product_quantity, query, conn, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        res = new DefaultRespons_1.default();
